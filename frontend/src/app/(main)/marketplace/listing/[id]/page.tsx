...
import { MorphPayment } from "@/components/pages/(marketplace)/MorphPayment";
        ...
        <section className="glass-panel-strong rounded-[1.5rem] p-6 sm:p-8">
          <div className="flex items-start justify-between gap-4">
            ...
            <div className="glass-inset rounded-[1rem] px-4 py-4 text-right">
              ...
              <p className="text-sm text-text-secondary">USDC on Morph</p>
            </div>
          </div>
          ...
          {!isConnected || !user ? (
            ...
            <div className="mt-8 space-y-6 border-t border-border-main pt-8">
              <MorphPayment listing={listing} sellerAgentId={listing.sellerAgentId} buyerAgentId={user.id} />
          ...
          <p className="mt-6 text-center text-xs text-text-secondary">Secured by Morph Network</p>
        </section>
      </main>
    </div>
  );
